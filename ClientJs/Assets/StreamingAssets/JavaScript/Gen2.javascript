    ...
    Bridge.define("Nova.Actor", {
        ...
        config: {
            ...
            init: function () {
                ...
                this.ais = new (System.Collections.Generic.List$1(Nova.AI))();
            }
        },
        getPx: function () {
        ...
        OnTimeElapsed: function (te) {
            var $t;
            $t = Bridge.getEnumerator(this.ais);
            while ($t.moveNext()) {
                var ai = $t.getCurrent();
                ai.OnTimeElapsed(te);
            }
        ...
        AddAI: function (T) {
            if (this.GetAI(T) == null) {
                var ai = Bridge.createInstance(T);
                ai.setOwner(this);
                this.ais.add(ai);
            }
        },
