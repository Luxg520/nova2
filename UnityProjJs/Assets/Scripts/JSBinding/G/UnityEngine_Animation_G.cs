...
public class UnityEngine_Animation_G
{
    ////////////////////// Animation ///////////////////////////////////////
    // constructors
    static bool Animation_Animation(JSVCall vc, int argc)
    {
    ...
    static bool Animation_GetClipCount(JSVCall vc, int argc)
    {
        ...
        if (len == 0)
        {
            JSApi.setInt32((int)JSApi.SetType.Rval, (int)(((UnityEngine.Animation)vc.csObj).GetClipCount()));
        }
        return true;
    }
    ...
    static bool Animation_IsPlaying__String(JSVCall vc, int argc)
    {
        ...
        {
            string arg0 = JSApi.getStringS((int)JSApi.GetType.Arg);
            JSApi.setBooleanS((int)JSApi.SetType.Rval, (bool)(((UnityEngine.Animation)vc.csObj).IsPlaying(arg0)));
        }
        return true;
    }
    static bool Animation_Play(JSVCall vc, int argc)
    {
        ...
        if (len == 0)
        {
            JSApi.setBooleanS((int)JSApi.SetType.Rval, (bool)(((UnityEngine.Animation)vc.csObj).Play()));
        }
        return true;
    }
    static bool Animation_Play__String(JSVCall vc, int argc)
    {
        ...
        {
            string arg0 = JSApi.getStringS((int)JSApi.GetType.Arg);
            JSApi.setBooleanS((int)JSApi.SetType.Rval, (bool)(((UnityEngine.Animation)vc.csObj).Play(arg0)));
        }
        return true;
    }
    static bool Animation_Play__String__PlayMode(JSVCall vc, int argc)
    {
        ...
        if (len == 2)
        {
            ...
            JSApi.setBooleanS((int)JSApi.SetType.Rval, (bool)(((UnityEngine.Animation)vc.csObj).Play(arg0, arg1)));
        }
        return true;
    }
    ...
    public static void __Register()
    {
        ...
        {
            new JSMgr.MethodCallBackInfo(Animation_Animation, ".ctor"),
        };
